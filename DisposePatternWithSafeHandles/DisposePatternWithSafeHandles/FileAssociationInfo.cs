...
namespace DisposePatternWithSafeHandles
{
    public class FileAssociationInfo : IDisposable
    {
        ...
        public FileAssociationInfo(String fileExtension)
        {
            ...
            // Instantiate the first SafeReegistryHandle.
            ...
            IntPtr hAppId;
            retVal = RegOpenKeyEx(new IntPtr(HKEY_CLASSES_ROOT), appId, 0, KEY_QUERY_VALUE | KEY_SET_VALUE, out hAppId);
            ...
            // Instantiate the second SafeRegitryHandle.
            ...
            // Determine the number of characters without the terminating null.
            exePath = exePath.Substring(0, (int)exeNameLength / 2 - 1);
        ...
        public string Open
        {
            ...
            set
            {
                ...
                string cmd = value + " %1";
                int retVal = RegSetValueEx(hAppIdHandle.DangerousGetHandle(), String.Empty, 0, REG_SZ, value, value.Length + 1);
        ...
        protected void Dispose(bool disposing)
        {
            ...
            // but all are wrapped by save handles.
